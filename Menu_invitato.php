...
<nav class="navbar navbar-expand-md navbar-dark  bg-dark">
  ...
  <path fill-rule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"/>
    ...
    <?php echo $_SESSION['Invitato']->get_nome();?></a>
    ...
    <div class="navbar-collapse collapse" id="navbarCollapse" style="">
      <ul class="navbar-nav ml-auto ">
        <li class="nav-item">
          <a class="nav-link" href="Dashboard_invitato.php">Home </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Elenco_Regali.php">Partecipa</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Le_mie_partecipazioni.php">Lista partecipazioni</a>
        </li>
        <li class="nav-item">
